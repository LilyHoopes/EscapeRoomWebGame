class SceneManager {
    ...
    loadRoom(roomName, spawnX, spawnY) {
        ...
        if (roomName === "room5") {
            ...
            this.game.addEntity(new Door(this.game, 700, 25, 250, 200, "ending", 0, 0, "./Sprites/Room5/FinalDoorLocked.png", "./Sprites/Room5/FinalDoorOpen.png", true, 1.0)); // room5 -> ending screen
